...
@author: Tanmay Tiwari (Silent Programmer)
...
def show_about():
	...
	text.insert(tk.END, 'Author : Tanmay Tiwari \n')
...
def get_help():
	url = 'https://github.com/Tanmay-Tiwaricyber/Coastline-Text-Editor/blob/main/README.md'
	webbrowser.open(url)
